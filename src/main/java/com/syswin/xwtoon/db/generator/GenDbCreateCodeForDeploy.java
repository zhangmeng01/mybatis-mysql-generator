 ...
 * 自动代码生成工具操作类
 */
public class GenDbCreateCodeForDeploy {

	private static Logger logger = LoggerFactory.getLogger(GenDbCreateCodeForDeploy.class);
	// 项目的命名空间
	private static final String MODULE = "deploy";
	...
	private static final String TEMPLETE_PATH = DIRCTORY_PATH
			+ "xwtoon-tools//src//main//resources//generator//deploytemplates";
	...
	private static final String CONTROLLER_PATH = DIRCTORY_PATH
			+ "xwtoon-app//src//main//java//com//syswin//xwtoon//app//controller//deploy//";

	private static final String ENTITY_PATH = DIRCTORY_PATH
			+ "xwtoon-dao//src//main//java//com//syswin//xwtoon//entity//deploy//";
	private static final String DAO_PATH = DIRCTORY_PATH
			+ "xwtoon-dao//src//main//java//com//syswin//xwtoon//dao//deploy//";
	private static final String MAPPER_PATH = DIRCTORY_PATH + "xwtoon-dao//src//main//resources//mappings//deploy//";

	private static final String SERVICEIMPL_PATH = DIRCTORY_PATH
			+ "xwtoon-app-service//src//main//java//com//syswin//xwtoon//app//service//impl//deploy//";
	private static final String SERVICE_PATH = DIRCTORY_PATH
			+ "xwtoon-app-interface//src//main//java//com//syswin//xwtoon//app//service//deploy//";
	private static final String ENTITY_INTERFACE_PATH = DIRCTORY_PATH
			+ "xwtoon-app-interface//src//main//java//com//syswin//xwtoon//app//service//bean//deploy//";
	...
	public GenDbCreateCodeForDeploy() {
		// 初始化FreeMarker配置
		// 创建个Configuration实例
	...
	public static void main(String[] args) {
		try {
			GenDbCreateCodeForDeploy hf = new GenDbCreateCodeForDeploy();

			// 过滤点不用生成的表
			talbes = GenDb.getInstance().getTableName("qrtz");
			// hf.GenProcess(hf);
			hf.GenSingleProcess(hf, "org_deploy_token"); // 指定单个数据库表生成代码;
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	 ...
	 * @author llh
	 */
	public void GenSingleProcess(GenDbCreateCodeForDeploy hf, String tableName) throws Exception {
...
//    		 hf.buildTemplate(root,FTL_TEMPLATE_PATH,GenUtils.firstCharacterToUpper(className)+"_edit.ftl",pageForm,isOverwrite);
	 ...
	 * @author llh
	 */
	public void GenProcess(GenDbCreateCodeForDeploy hf) throws Exception {
		Map<String, Object> root = new HashMap<String, Object>();
		setPageParm(root);
		Template template = cfg.getTemplate("entity.ftl");
		Template templateMapper = cfg.getTemplate("mapper.ftl");
