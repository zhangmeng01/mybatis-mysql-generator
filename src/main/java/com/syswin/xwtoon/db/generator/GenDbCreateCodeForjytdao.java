 ...
 * 自动代码生成工具操作类
 */
public class GenDbCreateCodeForjytdao {

	private static Logger logger = LoggerFactory.getLogger(GenDbCreateCodeForjytdao.class);
	// 项目的命名空间
	private static final String MODULE = "biz";
	private static final String PACKAGE = "jyt.xiaotoon";
	private static final String PACKAGE_SERVICE = "net.dcjy.dcdy.app.service";
	...
	private static final String DIRCTORY_PATH = "D://workspacejytoon//git//jyt_class//";
	...
	private static final String TEMPLETE_PATH = DIRCTORY_PATH_TEMPLATE
			+ "xwtoon-tools//src//main//resources//generator//jyttemplate";
	...
	private static final String ENTITY_PATH = DIRCTORY_PATH + "jyt-dao//src//main//java//jyt//xiaotoon//entity//";
	private static final String DAO_PATH = DIRCTORY_PATH
			+ "jyt-user-service//src//main//java//com//jyt//user//service//dao//";
	private static final String MAPPER_PATH = DIRCTORY_PATH + "jyt-dao//src//main//resources//mappings//";

	private static final String ENTITY_ORG_PATH = DIRCTORY_PATH
			+ "jyt-user-service//src//main//java//com//jyt//user//service//org//entity//";

	private static final String SERVICEIMPL_PATH = DIRCTORY_PATH
			+ "dcdy-app-service//src//main//java//net//dcjy//dcdy//app//service//impl//";
	private static final String SERVICE_PATH = DIRCTORY_PATH
			+ "dcdy-app-interface//src//main//java//net//dcjy//dcdy//app//service//";
	private static final String ENTITY_INTERFACE_PATH = DIRCTORY_PATH
			+ "dcdy-app-interface//src//main//java//net//dcjy//dcdy//app//service//bean//";
	...
	public GenDbCreateCodeForjytdao() {
		// 初始化FreeMarker配置
		// 创建个Configuration实例
	...
	public static void main(String[] args) {
		try {
			GenDbCreateCodeForjytdao hf = new GenDbCreateCodeForjytdao();
			// 过滤点不用生成的表
			 ...
			 */
//		    hf.GenSingleProcess("jyt_class_group_notice"); //指定单个数据库表生成代码;
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	...
	public void GenSingleProcess(String tableName) throws Exception {
		...
		className = GenUtils.replaceUnderlineAndfirstToUpper(tableName.replace("jyt", ""), "_", "");
...
//		 createController();
	 ...
	 * @author llh
	 */
	public void GenProcess(GenDbCreateCodeForjytdao hf) throws Exception {
	...
	public void createDao() throws Exception {
		...
		GenDbCreateCodeForjytdao.buildTemplate(root, ENTITY_PATH, GenUtils.firstCharacterToUpper(className) + ".java",
				template, isOverwrite);
		GenDbCreateCodeForjytdao.buildTemplate(root, MAPPER_PATH, GenUtils.firstCharacterToUpper(className) + ".xml",
				templateMapper, isOverwrite);
//		GenDbCreateCodeForjytdao.buildTemplate(root,DAO_PATH,"I"+GenUtils.firstCharacterToUpper(className)+"Dao.java",templateDao,isOverwrite);

//		GenDbCreateCodeForjytdao.buildTemplate(root,ENTITY_ORG_PATH,GenUtils.firstCharacterToUpper(className)+".java", template,isOverwrite);
	}
	...
	public void createServiceEntity() throws Exception {
		...
		GenDbCreateCodeForjytdao.buildTemplate(root, ENTITY_INTERFACE_PATH,
	...
	public void createServiceImpl() throws Exception {
		...
		root.put("package", PACKAGE_SERVICE);
		GenDbCreateCodeForjytdao.buildTemplate(root, SERVICE_PATH,
				"I" + GenUtils.firstCharacterToUpper(className) + "Service.java", templateService, isOverwrite);
		GenDbCreateCodeForjytdao.buildTemplate(root, SERVICEIMPL_PATH,
	...
	public void createController() throws Exception {
		...
		GenDbCreateCodeForjytdao.buildTemplate(root, CONTROLLER_PATH,
		...
		GenDbCreateCodeForjytdao.buildTemplate(root, FTL_TEMPLATE_PATH,
